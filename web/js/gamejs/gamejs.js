/*
 * GameJs converted to requirejs via r.js and its convert tool. Some minor
 * modifications were made, mainly removing "./gamejs" references from this
 * file as it needed to be moved from ../ to the proper package directory.
 */
...
define(function(require, exports, module) {
	 ...
	 * @ignore
	 */
	exports.surfacearray = require('./surfacearray');
	/**
	 * @ignore
	 */
	 ...
	 */
	exports.pathfinding = {
		astar: require('./pathfinding/astar')
	};
